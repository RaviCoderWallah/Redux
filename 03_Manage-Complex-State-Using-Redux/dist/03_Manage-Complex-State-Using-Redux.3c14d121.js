...
const initialState = {
    products: (0, _productsDataListJs.productList),
    cartItems: [],
    wishList: []
};
...
store.dispatch({
    type: CART_INCREASE_QUNATITY,
    payload: 2
});
store.dispatch({
    type: CART_DECREASE_QUNATITY,
    payload: 14
});

},{"redux":"7RvxM","./productsDataList.js":"hH2p5"}],"7RvxM":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["n0fw4","kTBnD"], "kTBnD", "parcelRequire359e", {})

//# sourceMappingURL=03_Manage-Complex-State-Using-Redux.3c14d121.js.map
